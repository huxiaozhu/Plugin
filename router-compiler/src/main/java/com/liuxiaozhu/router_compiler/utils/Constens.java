...
public class Constens {
    ...
    public static final ClassName ROUTER = ClassName.get("com.liuxiaozhu.router_core", "DNRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "com.liuxiaozhu.router_annotation.Route";
    public static final String ANN_TYPE_Extra = "com.liuxiaozhu.router_annotation.Extra";


    public static final String IROUTE_GROUP = "com.liuxiaozhu.router_core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.liuxiaozhu.router_core.template.IRouteRoot";
    public static final String IEXTRA = "com.liuxiaozhu.router_core.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "com.liuxiaozhu.router_core.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.liuxiaozhu.router";
}
